...
| QA-10 | Three-point rectangle | Core — partial, not passed | Rotated sizing/reselection retained. September10 reverse-baseline Escape omission corrected: first cancels placement, second disarms, paired live; readout strike-through removed. Clean29/29 plus separate3/3; illustrated631/master38 verified. Pending baseline numeric84ca852 and committed Undo disarming c154574 now pushed/live-compared, separate23/23+3/3 and4/4; illustrated642/master38 verified. Fresh center release/control fixed and paired live, report653/master38; strict isolated legacy groups recovered, clean54/54 and live controlled archive/gallery center/history/reopen, report667/master38; pending leader fixed spacing, reverse readable-side placement and four-decimal precision now paired; clean5/5 and history/reopen, report687/master38. System file picker and remaining angled completion directions remain open. |
