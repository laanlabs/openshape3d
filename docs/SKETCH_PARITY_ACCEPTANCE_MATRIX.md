...
| QA-08 | Diagonal rectangle | Core — partial live pass | Quadrants, both sizing orders, anchors, center/Lock/corners and saved recovery paired; historical publication recovered. Fresh axis-primitive commit/history selection comparison and consolidated regression pending. |
| QA-09 | Center rectangle | Core — partial, not passed | Both sizing orders, four release directions, center Lock/migration and selected-side/corner fixes paired; report598 verified. Axis-primitive commit/history lifecycle and consolidated regression remain before finite closure. |
