...
| QA-13 | Arc construction | Core — partial, not passed | Two endpoint taps/default45° and pending radius+sweep presentation paired; clone midpoint adjustment/major preview pass, but native third-point placement, Return/chaining, major/minor and tangent transition remain unresolved (direct-arc/default-shape/pending-feedback receipts). |
