...
- **Next:** capture the after-fix open timings on the unlocked iPad; post-merge full run on main; then a physical iPad session for QA-52 (needs Jason).
