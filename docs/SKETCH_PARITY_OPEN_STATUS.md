...
- 2026-09-14 (08:20): **iPad feedback 3** — the Copy badge now applies to a typed gizmo distance (duplicate, move the copy), as to a drag; GizmoTypedCopyTests 3/3. Branch fix/typed-move-copies off main (b188b59). See testing/ipad-feedback-2026-09-14.md §3.
- 2026-09-14 (09:10): **iPad feedback 4** — gizmo at the selection's bounding-box centre, rotation about it; tap the pivot for a "move the gizmo" mode (cbfd123). Branch fix/gizmo-center-and-reposition (carries PR #30 until it merges). See testing/ipad-feedback-2026-09-14.md §4.
- 2026-09-14 (09:15): PRs #30 and #31 merged by Jason (2c89dcd); main built to the iPad. Full run on 063e959: unit 1613/1613, UI 187 executed, 4 skipped, 0 failures. GizmoFlowUITests re-derived for the centred gizmo, 5/5 with the Reposition/Recenter test (PR #32).
