...
Branch `fix/sketch-parity-foundations`, PR https://github.com/laanlabs/openshape3d/pull/29. HEADd200712 pushed; baseline/reselection correction dirty in EditorViewModel.swift, RectangleConstruction.swift, RectangleConstructionTests.swift, receipt/checkpoint. Inspect actual HEAD/status. This dedicated session owns desktop; Serial gallery/relaunch Undo UI diagnostic active exec99402, `/tmp/os3d-gallery-undo-profile-20260907.xcresult`; no Peekaboo during run. Reselection run21/21 passed. No duplicate workers. Simulator os3d-parity-sept7, UDID AC2FD923-1661-435F-BF47-3E9DF30D1A16. Latest installed simulator executable SHA256990cc2dd9b4dbd1a1935412e5bd31ee02c3f963e5b94d9188162adba10501ef8, app `/tmp/os3d-parity-derived/Build/Products/Debug-iphonesimulator/openshape3d.app`.
...
23:05 EDT: d200712 pushed; only new gallery Undo test + checkpoint dirty. Active exec96606.33image Doc verified; latest paired reopen note still needs publication.

23:08 EDT initial galleryUndo run failed only post-redo badge expectation; Undo removed labels. New stronger profile check tests absent/extrudable afterUndo/Redo, activeexec99402. No source Undo change.

23:10 EDT exec99402 completedPASS1/1; screenshots confirm profile absent afterUndo and restored/extrudable afterRedo. No test process active. Retaining gallery-launch regression; next paired live line chain/cancel or non-ground plane entry. Live toolbar discrepancy remains open.
